...
/**
 * Test case for class PHTH\Sportresults\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \PHTH\Sportresults\Controller\EventController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('PHTH\\Sportresults\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
	{
		...
		$eventRepository = $this->getMock('PHTH\\Sportresults\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$event = new \PHTH\Sportresults\Domain\Model\Event();
	...
	public function createActionAddsTheGivenEventToEventRepository()
	{
		...
		$eventRepository = $this->getMock('PHTH\\Sportresults\\Domain\\Repository\\EventRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenEventInEventRepository()
	{
		...
		$eventRepository = $this->getMock('PHTH\\Sportresults\\Domain\\Repository\\EventRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenEventFromEventRepository()
	{
		...
		$eventRepository = $this->getMock('PHTH\\Sportresults\\Domain\\Repository\\EventRepository', array('remove'), array(), '', FALSE);
