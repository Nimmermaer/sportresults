...
/**
 * Test case for class \PHTH\Sportresults\Domain\Model\Player.
 *
...
{
	/**
	 * @var \PHTH\Sportresults\Domain\Model\Player
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \PHTH\Sportresults\Domain\Model\Player();
	}
	 ...
	 * @test
	 */
	public function getShirtNumberReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getShirtNumber()
		);
	}
	 ...
	 * @test
	 */
	public function setShirtNumberForStringSetsShirtNumber()
	{
		$this->subject->setShirtNumber('Conceived at T3CON10');
