...
/**
 * Test case for class \PHTH\Sportresults\Domain\Model\Event.
 *
...
class EventTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = new \PHTH\Sportresults\Domain\Model\Event();
	}
	 ...
	 * @test
	 */
	public function getKindReturnsInitialValueForInt()
	{	}

	/**
	 * @test
	 */
	public function setKindForIntSetsKind()
	{	}
